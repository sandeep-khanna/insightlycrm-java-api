...
import com.insightly.model.Permissions;
...
@Component("com.insightly.PermissionsApi")
public class PermissionsApi {
     ...
     */
    public Permissions getPermissions() throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/Permissions").build().toUriString();
