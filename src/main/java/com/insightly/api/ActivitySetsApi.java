...
import com.insightly.model.ActivitySet;
...
@Component("com.insightly.ActivitySetsApi")
public class ActivitySetsApi {
     ...
     * <p><b>404</b> - Activity Set not found.
     * @param id An Activity Set&#39;s ID
     * @return ActivitySet
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ActivitySet getActivitySet(Long id) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling getActivitySet");
        }
        
        // create path and map variables
        final Map<String, Object> uriVariables = new HashMap<String, Object>();
        uriVariables.put("id", id);
        String path = UriComponentsBuilder.fromPath("/ActivitySets/{id}").buildAndExpand(uriVariables).toUriString();
        ...
        ParameterizedTypeReference<ActivitySet> returnType = new ParameterizedTypeReference<ActivitySet>() {};
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public List<ActivitySet> getActivitySets(Boolean brief, Integer skip, Integer top, Boolean countTotal) throws RestClientException {
        Object postBody = null;
        
        String path = UriComponentsBuilder.fromPath("/ActivitySets").build().toUriString();
        ...
        ParameterizedTypeReference<List<ActivitySet>> returnType = new ParameterizedTypeReference<List<ActivitySet>>() {};
        return apiClient.invokeAPI(path, HttpMethod.GET, queryParams, postBody, headerParams, formParams, accept, contentType, authNames, returnType);
    }
}
